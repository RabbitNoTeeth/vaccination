...
import com.god.gl.vaccination.main.home.adapter.EducationAdapter;
...
public class EducationActivity extends BaseActivity {
    ...
    protected void initView(Bundle savedInstanceState) {
        ...
        mEducationAdapter = new EducationAdapter(mContext,R.layout.item_education,mDataBeanList);
    ...
    protected void handleData() {
        ...
        mEducationAdapter.setOnItemClickListener(new MultiItemTypeRecyclerAdapter.OnItemClickListener() {
            @Override
    ...
    private void getList(){
        ...
        params.put("category_id", Global.EDUCATION_ID);
                        ...
                        if (null != articleBean && null != articleBean.data && null != articleBean.data.data){
                            if (page==1){
                                ...
                                if (articleBean.data.data.size() > 0) {
                                    mEducationAdapter.refresh(articleBean.data.data);
                                } else {
                                ...
                                if (articleBean.data.data.size()>0){
                                    mEducationAdapter.addAll(articleBean.data.data);
                                }else {
