 ...
 * @desc
 */
public class DailyHealthAdapter extends AdapterBase<ArticleBean.DataBeanX.DataBean> {

    public DailyHealthAdapter(Context context, int layoutId, List<ArticleBean.DataBeanX.DataBean> datas) {
